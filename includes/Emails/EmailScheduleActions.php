...
class EmailScheduleActions {
	...
	public static function init() {
		add_action( 'masteriyo/schedule/email/rest-password', array( __CLASS__, 'send_reset_password' ) );
	 ...
	 */
	public static function send_reset_password( $user_id ) {
		$email = new ResetPasswordEmail();
		$email->trigger( $user_id, wp_generate_password() );
	}
